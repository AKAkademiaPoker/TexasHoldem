...
public enum MenuPoint {
	...
	TOP_10_MONTH("Top 10 ebben a honapban"), POKER_HANDS("Póker kezek"), FIX_LIMIT("Fix limit"), NO_LIMIT("No limit"), POT_LIMIT("Pot limit"), CALL("Tartás"), FOLD("Eldobás"), RAISE("Emelés"),
	CHECK("Passzolás"), TO_PREVIOUS("Az előző menűhöz"), ERROR("Hibás");
